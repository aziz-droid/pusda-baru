    ...
    public function getDataUPTAllExport(Request $request)
    {
        ...
        $data = $childer->map(function ($childer) {
            return [
                ...
                'Nama/Jenis Barang' => $childer->parent->item_name,
                ...
                'Longitude' => $childer->parent->longitude,
                'Latitude' => $childer->parent->latitude,
                ...
                'Longitude Tanah Bagian' => $childer->longitude,
                'Latitude Tanah Bagian' => $childer->latitude,
                'Luas' => $childer->large,
